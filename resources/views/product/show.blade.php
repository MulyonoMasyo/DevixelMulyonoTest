    ...
    <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <a href="/product" class="btn btn-success btn-sm">Kembali</a>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control"   name="name"  value=" {{$show->id }} " readonly >
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="price " name="price" value=" {{$show->price}} " readonly >
                </div>
                <div class="form-group">
                  <label for="color">color</label>
                  <input type="text" class="form-control" id="color " name="color" value=" {{$show->color }} "  readonly>
                </div>
                <div class="form-group">
                  <label for="color">Status</label>
                  <input type="text" class="form-control" id="color " name="color" value=" {{$show->Status->keterangan }} "  readonly>
                </div>
              </div>
