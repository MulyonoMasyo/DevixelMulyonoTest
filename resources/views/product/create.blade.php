  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="POST" action="/create-product-tambah">
                 {{csrf_field()}}
              <div class="box-body">
                <div class="form-group">
                  <label for="name">Name</label>
                  <input type="text" class="form-control"   name="name" placeholder="Contoh : meja" autocomplete="off">
                </div>
                <div class="form-group">
                  <label for="price">Price</label>
                  <input type="number" class="form-control" id="price " name="price" placeholder="contoh :8000" autocomplete="off">
                </div>
               <div class="form-group">
                  <label for="color">color</label>
                  <input type="text" class="form-control" id="color " name="color" placeholder="contoh :merah" autocomplete="off">
                </div>
              </div>
              <div class="form-group">
                  <label>Status</label>
                  <select class="form-control" name="status_id">
                    <option selected="selected" disabled="true">--Pilih Status--</option>
                    @foreach($status as $s)
              ...
              <div class="box-footer">
                ...
                <a href="/product" class="btn btn-success ">Kembali</a>
              </div>
            </form>
          </div>
          <!-- /.box -->
